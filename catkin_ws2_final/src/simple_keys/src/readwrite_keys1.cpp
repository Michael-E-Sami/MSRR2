...
int main(int argc,char **argv)
{
    ...
    init(argc,argv,"readwrite_keys1");
    NodeHandle n;
    // NodeHandle l;
    ...
    velocity_publisher1 = n.advertise<Float32>("/" + s.data + std::to_string(1) +"/left_wheel_speed", 10);
    velocity_publisher2 = n.advertise<Float32>("/" + s.data + std::to_string(1) +"/right_wheel_speed", 10);
    velocity_publisher3 = n.advertise<Float32>("/" + s.data + std::to_string(1) +"/front_face", 10);
    velocity_publisher4 = n.advertise<Float32>("/" + s.data + std::to_string(1) +"/face_pan", 10);
