...
int main(int argc,char **argv)
{
    ...
    cin>>num;
    init(argc,argv,"readwrite_keys"+num);
    NodeHandle n;
    // NodeHandle l;
    ...
    velocity_publisher1 = n.advertise<Float32>("/" + s.data + num +"/left_wheel_speed", 10);
    velocity_publisher2 = n.advertise<Float32>("/" + s.data + num +"/right_wheel_speed", 10);
    velocity_publisher3 = n.advertise<Float32>("/" + s.data + num +"/front_face", 10);
    velocity_publisher4 = n.advertise<Float32>("/" + s.data + num +"/face_pan", 10);
