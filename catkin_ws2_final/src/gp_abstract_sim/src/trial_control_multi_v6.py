...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        rx, ry = a_star.planning(currentX[0], currentY[0], currentPath.x[size-1], currentPath.y[size-1])
        rx.reverse()
        ry.reverse()
        ...
        for i in range(1, sizeTwo):
            ...
            print 'current path.x[i] = ', rx[i]
            print 'currenpt path.y[i] = ', ry[i]
            print ' '
            ...
            forwardFn(tempX0, tempY0, 0.3, str(movingDitto[0]))
