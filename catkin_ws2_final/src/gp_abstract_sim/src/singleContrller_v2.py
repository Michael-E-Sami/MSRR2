...
def main():
    global dittoS, dittoG, angleToNext, distToNext,angleToNext_diff, angleToNext_old
    ...
    # rotate(0.15, lastAngle, int(dittoG))
    # rospy.sleep(1)
    # rotate(0.15, 0, int(dittoG))
    # rotate(0.15, 0,int(dittoG))
    # forwardFn(0.1, 0.15, int(dittoG))
    ...
    while not rospy.is_shutdown():
        for i in range(1, size):
            ...
            print 'actual= ',current_yaw
            print 'next= ',angleToNext
            print 'old= ' , angleToNext_old
            print 'diff= ',angleToNext_diff
            print ' '
            # ROTATE
            rotate(0.15,angleToNext_diff,int(dittoS))
            rotate(0.1,0,int(dittoS))
            rotate(0.1,0,int(dittoS))

            # FORWARD
            forwardFn(distToNext,0.25,int(dittoS))
