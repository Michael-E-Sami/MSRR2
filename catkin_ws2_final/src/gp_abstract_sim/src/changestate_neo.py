    ...
    while not rospy.is_shutdown():
        for i in range(1, size):
            ...
            if amp_resolution:
                ...
                while (abs(current_yaw - gyaw) > 0.005) and (abs(current_yaw - gyaw)<0.04)and (not rospy.is_shutdown()):
                    print("aho fe A?-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
            ...
            while euc > euc_condition and not rospy.is_shutdown():
                ...
                #while abs(angle_to_goal - current_yaw) < 0.09 and abs(angle_to_goal - current_yaw) > 0.04:
                #    print("aho fe A?-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
                #    brake(left_pubG,right_pubG)
                #    statecall(dittoS,dittoG)
                #while abs(angle_to_goal - current_yaw) < 0.005 and abs(angle_to_goal - current_yaw) > 0.002:
                #    pose_achieved = True
                ...
                #if(gyaw >0.34) and (gyaw <0.42):
                #    while (abs(current_yaw - gyaw) > 0.1) and (abs(current_yaw - gyaw)<0.15):
                #        print("aho fe A?-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
                #        brake(left_pubG,right_pubG)
                #        statecall(dittoS,dittoG)
            if(flagdamn==True):
            #damn=statecall()
                ...
                print("AYWAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
        perf_x.append(current_x)
        perf_y.append(current_y)
