...
void ContactPlugin::Load(sensors::SensorPtr _sensor, sdf::ElementPtr _sdf)
{
	...
	pub = n.advertise<std_msgs::String>(parent + "/sensor_data", 100);
}
...
void ContactPlugin::OnUpdate()
{
	...
	//faces.data = contacts.contact(0).collision1() + contacts.contact(0).collision2();
	//pub.publish(faces);
	for (unsigned int i = 0; i < contacts.contact_size(); ++i)
	{
		faces.data = contacts.contact(i).collision1() + "#" + contacts.contact(i).collision2();
		pub.publish(faces);
		...
		// 				{
		// 					//ditto2/body#ditto1/body//ditto2/body#ditto1/body
